...
CREATE TABLE `app_notifications` (
  ...
  KEY `task_id` (`task_id`),
  CONSTRAINT `app_notifications_ibfk_1` FOREIGN KEY (`user_email`) REFERENCES `users` (`email`) ON DELETE CASCADE,
  CONSTRAINT `app_notifications_ibfk_2` FOREIGN KEY (`task_id`) REFERENCES `tasks` (`id`) ON DELETE CASCADE
...
INSERT INTO `push_subscriptions` VALUES (1,8,'{\"endpoint\":\"https://fcm.googleapis.com/fcm/send/eEo5eYAxg8E:APA91bFts1QMrufv6Qc7YKy6wNpfHW9hJwPzoartkAYc_Mgo6Fb335jcXSX89uVAZAl17nJsblU-0qJQz41EXg8Upqg5ghhJAcyjynKum-mWy73tvjQTafDAl4N9WwTjoBGagyorO1PX\",\"expirationTime\":null,\"keys\":{\"p256dh\":\"BCo7iMQWGaRKy7jB0bLpgaQCQoaC6u91VAqeM47syhYAqtBdd9CUNFnqKBcV4WPI812TJHn1sOmYAEHebSretHY\",\"auth\":\"uPKdx2C7rINHeOAC1yDxlg\"}}','2026-04-21 18:57:41');
...
INSERT INTO `task_comments` VALUES (3,6,'ely','ADMIN','hoa','2026-04-21 18:38:20'),(4,6,'ely','ADMIN','hola2','2026-04-21 18:55:19'),(5,6,'ely','ADMIN','hola3','2026-04-21 18:58:22');
